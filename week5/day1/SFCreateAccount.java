...
public class SFCreateAccount {
	...
	public void verify_account_name() throws InterruptedException {
		  ...
		  String VerifyName = driver.findElement(By.xpath(
		  "//*[text()='Account']/following::*[@slot='primaryField']")) .getText();
		  System.out.println("Account Name : " + VerifyName);	 
		/*
		 * Thread.sleep(3000); String VerifyName = driver.getTitle();
		 * System.out.println("Account Created Page Title : " + VerifyName);
		 */
		if (VerifyName.contains(AccName)) {
			System.out.println("Name Verified : " + AccName + " --> " + VerifyName);
		} else {
