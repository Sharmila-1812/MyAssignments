...
public class CreateLeadPage extends ProjectSpecificMethod{
	...
	public CreateLeadPage enterCompanyName() throws IOException {
		...
		try {
			getDriver().findElement(By.xpath("//input[@id='createLeadForm_companyName']")).sendKeys(prop.getProperty("cname"));
	...
	public CreateLeadPage enterFirstName() throws IOException {
		try {
			getDriver().findElement(By.xpath("(//input[contains(@id,'firstName')])[1]")).sendKeys(prop.getProperty("fname"));
	...
	public CreateLeadPage enterLastName() throws IOException {
		try {
			getDriver().findElement(By.xpath("//input[contains(@id,'lastName')]")).sendKeys(prop.getProperty("lname"));
	...
	public ViewLeadPage clickCreateLeadBtn() throws IOException {
		try {
			getDriver().findElement(By.xpath("//input[contains(@value,'Create Lead')]")).click();
